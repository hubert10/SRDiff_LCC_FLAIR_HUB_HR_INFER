...
class AutoencoderKL(nn.Module):
    ...
    mode can be taken. The decoder then reconstructs the input from the latent representation.
    ...
    def encode(self, x: torch.Tensor) -> DiagonalGaussianDistribution:
        ...
        # Encoder's output
        h = self.encoder(x)
        # print("x encoder AutoencoderKL:", x.shape)
        # print("h encoder AutoencoderKL:", h.shape)
    ...
    def decode(self, z: torch.Tensor) -> torch.Tensor:
        ...
        # Decoder's output
        dec = self.decoder(z)  # torch.Size([2, 4, 64, 64])
        # print("dec AutoencoderKL decoder:", dec.shape)
        return dec  # torch.Size([1, 4, 512, 512])
    ...
    def forward(self, input: torch.Tensor, sample_posterior: bool = True) -> tuple:
        ...
        # print("dec AutoencoderKL forward:", input.shape)
