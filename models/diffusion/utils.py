...
def make_ddim_timesteps(
    ...
    if ddim_discr_method == "uniform":
        ...
        # print("num_ddpm_timesteps:", num_ddpm_timesteps)
        # print("num_ddim_timesteps:", num_ddim_timesteps)
...
class DDIMSampler(object):
    ...
    def ddim_sampling(
        ...
        shape: Tuple[int, int, int],
        # x_HR: Optional[torch.Tensor] = None,
        x_T: Optional[torch.Tensor] = None,
    ...
    def p_sample_ddim(
        ...
        Args:
            x (torch.Tensor): Input tensor (HR image) not Random noise as it is in DDPM
        ...
        e_t = self.model.apply_model(x, t, c, x_HR)
