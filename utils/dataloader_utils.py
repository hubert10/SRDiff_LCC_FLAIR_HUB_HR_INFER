...
def stretch_standardize(
    img: torch.Tensor, type: str, mode: str = "sisr"
) -> torch.Tensor:
...
def normalize(sen2, spot6, max_s2_images=1):
...
# HISTOGRAM MATCHING
def histogram(sen2, spot6, max_s2_images=None):
...
# MOMENT MATCHING
def moment(sen2, spot6, max_s2_images=None):
    ...
    for channel_sen, channel_spot in zip(sen2, spot6):
        ...
        channel_result = (
            ((channel_spot - spot6_mean) / spot6_stdev) * sen2_stdev
        ) + sen2_mean
